# This Game Is Created By Kunal Bumla
...
def intro():
    print_pause("You find yourself in a city corner in Washington")
...
def valid_input(prompt, option1, option2):
    while True:
        ...
        if option1 in response:
            ...
            print_pause("oops, I don't understand.")
    return response
...
def the_end():
    ...
    if "y" in play_again:
        ...
        print_pause("Thanks for playing the game!See You Again")


# the restaurant
def McDonald(items):
    print_pause(
        "You are now in McDonald, one of the Tasty place in the world")
    ...
    if "money" in items:
        print_pause(
            "Luckily you withdrawel some money and you can pay for meal now")
